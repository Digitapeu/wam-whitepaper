...
**WAM Coin** will be unlocked gradually in a pre-determined schedule that will last for 120 months from the Token Generation Event (TGE). The initial circulating supply is set to **20,000,000 WAM **with an initial market cap at list price of **US$500,000**.

![Token Allocation](../.gitbook/assets/image.png)
...
| Team              | 100,000,000       | 10%      | 12-months cliff, vested for 12 months, 8.33% released each month                     |
| Company Reserve   | 50,000,000        | 5%       | Vested for 24 months, 11.11% released quarterly                                      |
| Advisors          | 50,000,000        | 5%       | 12-months cliff, vested for 12 months, 8.33% released each month                     |
...
![WAM Coin Release Schedule](<../.gitbook/assets/image (1).png>)
